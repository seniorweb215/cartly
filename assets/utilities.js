  ...
  updateCart: function updateCart(lineID, quantity) {
    ...
    $.ajax({
      ...
      success: function success(cart) {
        ...
        var $listQuantityBox = $(".product-quantity-box[data-line-item=\"".concat(lineID, "\"]"));
        ...
        if(cart.items[cartItemsLineID].quantity == 1) {
          $('.quantity-minus', $listQuantityBox).attr('disabled', true);
        } else {
          $('.quantity-minus', $listQuantityBox).attr('disabled', false);
        }
        $listQuantityBox.find("input.quantity-input").val(cart.items[cartItemsLineID].quantity);
